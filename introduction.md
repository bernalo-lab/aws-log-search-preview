...
<div style="display:flex; justify-content:flex-end; margin-top:18px;">
  <a href="./incident-debugging-playbook.md" style="min-width:260px; border:1px solid #e5e7eb; border-radius:8px; padding:12px; text-decoration:none;">Incident Debugging Playbook</a>
</div>
